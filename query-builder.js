...
class QueryBuilder {
  ...
  static async findBy(tableName, field, value, columns = '*') {
    const { data, error } = await supabase.from(tableName).select(columns).eq(field, value).maybeSingle();
  ...
  static async exists(tableName, field, value) {
    const { data, error } = await supabase.from(tableName).select('id').eq(field, value).maybeSingle();
  ...
  static async create(tableName, data, returnColumns = '*') {
    const { data: result, error } = await supabase.from(tableName).insert([data]).select(returnColumns).single();
  ...
  static async createMany(tableName, dataArray, returnColumns = '*') {
    const { data, error } = await supabase.from(tableName).insert(dataArray).select(returnColumns);
  ...
  static async updateBy(tableName, field, value, data, returnColumns = '*') {
    const { data: result, error } = await supabase.from(tableName).update(data).eq(field, value).select(returnColumns);
  ...
  static async deleteBy(tableName, field, value) {
    const { data, error } = await supabase.from(tableName).delete().eq(field, value).select();
  ...
  static async deleteByIds(tableName, ids) {
    ...
    const { data, error } = await supabase.from(tableName).delete().in('id', validIds).select();
